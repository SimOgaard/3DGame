...
//        GameObject.Find("PlayerCam").GetComponent<Cinemachine>().transform.rotation
    }

    void Update()
    {
        //Quaternion targetRotation = Quaternion.FromToRotation(transform.up, GameObject.Find("Main Camera").transform.up) * transform.rotation;
